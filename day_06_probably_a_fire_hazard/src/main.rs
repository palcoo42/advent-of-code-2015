...
use example::{
    action::Action, bulb_complex::BulbComplex, bulb_simple::BulbSimple, grid::Grid, reader::Reader,
};
...
fn main() {
    ...
    let mut grid: Grid<BulbSimple> = Grid::new(1000, 1000);
    ...
    println!("Part 2: Brightness: {}", grid.get_brightness());
}
